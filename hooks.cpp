...
bool InstallLuaHook()
{
    ...
    static HookEntry hooks[] = {
        {0x8688B0, (LPVOID)&LuaNewStateDetour,     (LPVOID*)&original_newstate},
        {0x846D90, (LPVOID)&lua51L_newmetatable,   (LPVOID*)&original_newmetatable},
        {0x845B70, (LPVOID)&lua51_pushValue,       (LPVOID*)&original_pushvalue},
        {0x846440, (LPVOID)&lua51_setField,        (LPVOID*)&original_setfield},
        {0x847B90, (LPVOID)&lua51L_register,       (LPVOID*)&original_register},
        {0x8460C0, (LPVOID)&lua51_pushcclosure,    (LPVOID*)&original_pushcclosure},
        {0x845FF0, (LPVOID)&lua51_pushstring,      (LPVOID*)&original_pushstring},
        {0x846160, (LPVOID)&lua51_pushboolean,     (LPVOID*)&original_pushboolean},
        {0x8477E0, (LPVOID)&lua51L_checklstring,   (LPVOID*)&original_checklstring},
        {0x847580, (LPVOID)&lua51L_loadstring,     (LPVOID*)&original_loadstring},
        {0x846A00, (LPVOID)&lua51_newuserdata,     (LPVOID*)&original_newuserdata}, // TODO: Recheck this
        {0x846200, (LPVOID)&lua51_getfield,        (LPVOID*)&original_getfield},
        {0x8476D0, (LPVOID)&lua51L_checkudata,     (LPVOID*)&original_checkudata},
        {0x846590, (LPVOID)&lua51_setmetatable,    (LPVOID*)&original_setmetatable},
        {0x845F90, (LPVOID)&lua51_pushinteger,     (LPVOID*)&original_pushinteger},
        {0x846730, (LPVOID)&lua51_pcall,           (LPVOID*)&original_pcall},
        {0x84BE80, (LPVOID)&lua51_resume,          (LPVOID*)&original_resume},
        {0x846410, (LPVOID)&lua51_settable,        (LPVOID*)&original_settable},
        {0x6E3FC0, (LPVOID)&getthreadcount,        (LPVOID*)&original_getthreadcount}, // Oddly low address
        {0x846830, (LPVOID)&lua51_gc,              (LPVOID*)&original_gc},
        {0x9080E0, (LPVOID)&lua51c_step,           (LPVOID*)&originalc_step},
        {0x846CA0, (LPVOID)&lua51_newthread,       (LPVOID*)&original_newthread},
        {0x8461D0, (LPVOID)&lua51_gettable,        (LPVOID*)&original_gettable},
        {0x8461A0, (LPVOID)&lua51_pushthread,      (LPVOID*)&original_pushthread},
        {0x8459B0, (LPVOID)&lua51_gettop,          (LPVOID*)&original_gettop},
        {0x8459C0, (LPVOID)&lua51_settop,          (LPVOID*)&original_settop},
        {0x845DB0, (LPVOID)&lua51_tolstring,       (LPVOID*)&original_tolstring},
        {0x846180, (LPVOID)&lua51_pushlightuserdata,(LPVOID*)&original_plud},
        {0x846260, (LPVOID)&lua51_rawget,          (LPVOID*)&original_rawget},
        {0x845A10, (LPVOID)&lua51_remove,          (LPVOID*)&original_remove},
        //{0x8464A0, (LPVOID)&lua51_rawset,          (LPVOID*)&original_rawset}, // Function looks completely different??? */
        {0x845C10, (LPVOID)&lua51_isnumber,        (LPVOID*)&original_isnumber},
        {0x845D40, (LPVOID)&lua51_tointeger,       (LPVOID*)&original_tointeger},
        {0x845990, (LPVOID)&lua51_atpanic,         (LPVOID*)&original_atpanic},
        {0x845BA0, (LPVOID)&lua51_type,            (LPVOID*)&original_type},
        {0x8466D0, (LPVOID)&lua51_call,            (LPVOID*)&original_call},
        {0x86C830, (LPVOID)&lua51_open_base,       (LPVOID*)&original_open_base},
        {0x845920, (LPVOID)&lua51_xmove,           (LPVOID*)&original_xmove},
        {0x8462A0, (LPVOID)&lua51_rawgeti,         (LPVOID*)&original_rawgeti},
        {0x8462E0, (LPVOID)&lua51_createtable,     (LPVOID*)&original_createtable},
        {0x845FB0, (LPVOID)&lua51_pushlstring,     (LPVOID*)&original_pushlstring},
        {0x846520, (LPVOID)&lua51_rawseti,         (LPVOID*)&original_rawseti},
        {0x846340, (LPVOID)&lua51_getmetatable,    (LPVOID*)&original_getmetatable},
        {0x845A60, (LPVOID)&lua51_insert,          (LPVOID*)&original_insert},
        {0x845AB0, (LPVOID)&lua51_replace,         (LPVOID*)&original_replace},
        {0x8471C0, (LPVOID)&lua51L_ref,            (LPVOID*)&originalL_ref},
        {0x847270, (LPVOID)&lua51L_unref,          (LPVOID*)&originalL_unref},
        {0x845F70, (LPVOID)&lua51_pushnumber,      (LPVOID*)&original_pushnumber},
        {0x845D00, (LPVOID)&lua51_tonumber,        (LPVOID*)&original_tonumber},
        {0x845C50, (LPVOID)&lua51_isstring,        (LPVOID*)&original_isstring},
        {0x845E90, (LPVOID)&lua51_touserdata,      (LPVOID*)&original_touserdata},
        {0x845CC0, (LPVOID)&lua51_lessthan,        (LPVOID*)&original_lessthan},
        {0x846940, (LPVOID)&lua51_next,            (LPVOID*)&original_next},
        {0x846980, (LPVOID)&lua51_concat,          (LPVOID*)&original_concat},
        {0x845E20, (LPVOID)&lua51_objlen,          (LPVOID*)&original_objlen},
        {0x8463A0, (LPVOID)&lua51_getfenv,         (LPVOID*)&original_getfenv},
        {0x846640, (LPVOID)&lua51_setfenv,         (LPVOID*)&original_setfenv},
        {0x846E20, (LPVOID)&lua51L_getmetafield,   (LPVOID*)&originalL_getmetafield},
        {0x846930, (LPVOID)&lua51_error,           (LPVOID*)&original_error},
        {0x84B930, (LPVOID)&lua51_yield,           (LPVOID*)&original_yield},
        {0x86B6E0, (LPVOID)&lua51open_string,      (LPVOID*)&original_open_string},
        {0x869B00, (LPVOID)&lua51open_math,        (LPVOID*)&original_open_math},
        {0x8693B0, (LPVOID)&lua51open_table,       (LPVOID*)&original_open_table},
        {0x866530, (LPVOID)&lua51_getinfo,         (LPVOID*)&original_getinfo},
        {0x865800, (LPVOID)&lua51_getstack,        (LPVOID*)&original_getstack},
        {0x850730, (LPVOID)&reportError,           (LPVOID*)&original_scriptcontextreport},
        {0x868A50, (LPVOID)&lua51_close,           (LPVOID*)&original_close},
        {0x845C80, (LPVOID)&lua51_rawequal,        (LPVOID*)&original_rawequal},
        {0x845D80, (LPVOID)&lua51_toboolean,       (LPVOID*)&original_toboolean},
        {0x845BC0, (LPVOID)&lua51_typename,        (LPVOID*)&original_typename},
        {0x846090, (LPVOID)&lua51_pushfstring,     (LPVOID*)&original_pushfstring},
        {0x845EE0, (LPVOID)&lua51_topointer,       (LPVOID*)&original_topointer},
        {0x8477B0, (LPVOID)&lua51L_checkany,       (LPVOID*)&originalL_checkany},
        {0x8475F0, (LPVOID)&lua51L_argerror,       (LPVOID*)&originalL_argerror},
        /*
        */
        {0x845F50, (LPVOID)&lua51_pushnil,         (LPVOID*)&original_pushnil}
