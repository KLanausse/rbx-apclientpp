...
bool InstallLuaHook()
{
    ...
    static HookEntry hooks[] = {
        ...
        {0x5FB100, (LPVOID)&lua51_pcall,           (LPVOID*)&original_pcall},
        {0x603610, (LPVOID)&lua51_resume,          (LPVOID*)&original_resume},
        {0x5FAE00, (LPVOID)&lua51_settable,        (LPVOID*)&original_settable},
        {0x56CB70, (LPVOID)&getthreadcount,        (LPVOID*)&original_getthreadcount},
        {0x5FB200, (LPVOID)&lua51_gc,              (LPVOID*)&original_gc},
        {0x64C400, (LPVOID)&lua51c_step,           (LPVOID*)&originalc_step},
        {0x5FB6D0, (LPVOID)&lua51_newthread,       (LPVOID*)&original_newthread},
        {0x5FABE0, (LPVOID)&lua51_gettable,        (LPVOID*)&original_gettable},
        {0x5FABB0, (LPVOID)&lua51_pushthread,      (LPVOID*)&original_pushthread},
        {0x5FA390, (LPVOID)&lua51_gettop,          (LPVOID*)&original_gettop},
        {0x5FA3A0, (LPVOID)&lua51_settop,          (LPVOID*)&original_settop},
        {0x5FA790, (LPVOID)&lua51_tolstring,       (LPVOID*)&original_tolstring},
        {0x5FAB90, (LPVOID)&lua51_pushlightuserdata,(LPVOID*)&original_plud},
        {0x5FAC70, (LPVOID)&lua51_rawget,          (LPVOID*)&original_rawget},
        {0x5FA3F0, (LPVOID)&lua51_remove,          (LPVOID*)&original_remove},
        {0x5FAE90, (LPVOID)&lua51_rawset,          (LPVOID*)&original_rawset},
        {0x5FA5F0, (LPVOID)&lua51_isnumber,        (LPVOID*)&original_isnumber},
        {0x5FA720, (LPVOID)&lua51_tointeger,       (LPVOID*)&original_tointeger},
        {0x5FA370, (LPVOID)&lua51_atpanic,         (LPVOID*)&original_atpanic},
        {0x5FA580, (LPVOID)&lua51_type,            (LPVOID*)&original_type},
        {0x5FB0A0, (LPVOID)&lua51_call,            (LPVOID*)&original_call},
        {0x6089E0, (LPVOID)&lua51_open_base,       (LPVOID*)&original_open_base},
        {0x5FA320, (LPVOID)&lua51_xmove,           (LPVOID*)&original_xmove},
        {0x5FACB0, (LPVOID)&lua51_rawgeti,         (LPVOID*)&original_rawgeti},
        {0x5FACF0, (LPVOID)&lua51_createtable,     (LPVOID*)&original_createtable},
        {0x5FA9C0, (LPVOID)&lua51_pushlstring,     (LPVOID*)&original_pushlstring},
        {0x5FAF00, (LPVOID)&lua51_rawseti,         (LPVOID*)&original_rawseti},
        {0x5FAD30, (LPVOID)&lua51_getmetatable,    (LPVOID*)&original_getmetatable},
        {0x5FA440, (LPVOID)&lua51_insert,          (LPVOID*)&original_insert},
        {0x5FA490, (LPVOID)&lua51_replace,         (LPVOID*)&original_replace},
        {0x5FBC10, (LPVOID)&lua51L_ref,            (LPVOID*)&originalL_ref},
        {0x5FBCC0, (LPVOID)&lua51L_unref,          (LPVOID*)&originalL_unref},
        {0x5FA980, (LPVOID)&lua51_pushnumber,      (LPVOID*)&original_pushnumber},
        {0x5FA6E0, (LPVOID)&lua51_tonumber,        (LPVOID*)&original_tonumber},
        {0x5FA630, (LPVOID)&lua51_isstring,        (LPVOID*)&original_isstring},
        {0x5FA8A0, (LPVOID)&lua51_touserdata,      (LPVOID*)&original_touserdata},
        {0x5FA6A0, (LPVOID)&lua51_lessthan,        (LPVOID*)&original_lessthan},
        {0x5FB300, (LPVOID)&lua51_next,            (LPVOID*)&original_next},
        {0x5FB340, (LPVOID)&lua51_concat,          (LPVOID*)&original_concat},
        {0x5FA800, (LPVOID)&lua51_objlen,          (LPVOID*)&original_objlen},
        {0x5FAD90, (LPVOID)&lua51_getfenv,         (LPVOID*)&original_getfenv},
        {0x5FB020, (LPVOID)&lua51_setfenv,         (LPVOID*)&original_setfenv},
        {0x5FB850, (LPVOID)&lua51L_getmetafield,   (LPVOID*)&originalL_getmetafield},
        {0x5FB2F0, (LPVOID)&lua51_error,           (LPVOID*)&original_error},
        {0x6030D0, (LPVOID)&lua51_yield,           (LPVOID*)&original_yield},
        {0x607870, (LPVOID)&lua51open_string,      (LPVOID*)&original_open_string},
        {0x605C70, (LPVOID)&lua51open_math,        (LPVOID*)&original_open_math},
        {0x605500, (LPVOID)&lua51open_table,       (LPVOID*)&original_open_table},
        {0x604530, (LPVOID)&lua51_getinfo,         (LPVOID*)&original_getinfo},
        {0x6038B0, (LPVOID)&lua51_getstack,        (LPVOID*)&original_getstack},
        {0x570A60, (LPVOID)&reportError,           (LPVOID*)&original_scriptcontextreport},
        {0x604A10, (LPVOID)&lua51_close,           (LPVOID*)&original_close},
        {0x5FA660, (LPVOID)&lua51_rawequal,        (LPVOID*)&original_rawequal},
        {0x5FA760, (LPVOID)&lua51_toboolean,       (LPVOID*)&original_toboolean},
        {0x5FA5A0, (LPVOID)&lua51_typename,        (LPVOID*)&original_typename},
        {0x5FAAA0, (LPVOID)&lua51_pushfstring,     (LPVOID*)&original_pushfstring},
        {0x5FA8F0, (LPVOID)&lua51_topointer,       (LPVOID*)&original_topointer},
