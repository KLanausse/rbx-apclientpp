...
bool InstallLuaHook()
{
    ...
    static HookEntry hooks[] = {
        {0x641910, (LPVOID)&LuaNewStateDetour,     (LPVOID*)&original_newstate},
        {0x636520, (LPVOID)&lua51L_newmetatable,   (LPVOID*)&original_newmetatable},
        {0x6352A0, (LPVOID)&lua51_pushValue,       (LPVOID*)&original_pushvalue},
        {0x635B80, (LPVOID)&lua51_setField,        (LPVOID*)&original_setfield},
        {0x637300, (LPVOID)&lua51L_register,       (LPVOID*)&original_register},
        {0x635820, (LPVOID)&lua51_pushcclosure,    (LPVOID*)&original_pushcclosure},
        {0x635750, (LPVOID)&lua51_pushstring,      (LPVOID*)&original_pushstring},
        {0x6358C0, (LPVOID)&lua51_pushboolean,     (LPVOID*)&original_pushboolean},
        {0x636F50, (LPVOID)&lua51L_checklstring,   (LPVOID*)&original_checklstring},
        {0x636D30, (LPVOID)&lua51L_loadstring,     (LPVOID*)&original_loadstring},
        {0x636110, (LPVOID)&lua51_newuserdata,     (LPVOID*)&original_newuserdata},
        {0x635960, (LPVOID)&lua51_getfield,        (LPVOID*)&original_getfield},
        {0x636E40, (LPVOID)&lua51L_checkudata,     (LPVOID*)&original_checkudata},
        {0x635CC0, (LPVOID)&lua51_setmetatable,    (LPVOID*)&original_setmetatable},
        {0x6356F0, (LPVOID)&lua51_pushinteger,     (LPVOID*)&original_pushinteger},
        {0x635E50, (LPVOID)&lua51_pcall,           (LPVOID*)&original_pcall},
        {0x63FDD0, (LPVOID)&lua51_resume,          (LPVOID*)&original_resume},
        {0x635B50, (LPVOID)&lua51_settable,        (LPVOID*)&original_settable},
        {0x5C52A0, (LPVOID)&getthreadcount,        (LPVOID*)&original_getthreadcount},
        {0x635F50, (LPVOID)&lua51_gc,              (LPVOID*)&original_gc},
        {0x67E6E0, (LPVOID)&lua51c_step,           (LPVOID*)&originalc_step},
        {0x636430, (LPVOID)&lua51_newthread,       (LPVOID*)&original_newthread},
        {0x635930, (LPVOID)&lua51_gettable,        (LPVOID*)&original_gettable},
        {0x635900, (LPVOID)&lua51_pushthread,      (LPVOID*)&original_pushthread},
        {0x6350E0, (LPVOID)&lua51_gettop,          (LPVOID*)&original_gettop},
        {0x6350F0, (LPVOID)&lua51_settop,          (LPVOID*)&original_settop},
        {0x6354E0, (LPVOID)&lua51_tolstring,       (LPVOID*)&original_tolstring},
        {0x6358E0, (LPVOID)&lua51_pushlightuserdata,(LPVOID*)&original_plud},
        {0x6359C0, (LPVOID)&lua51_rawget,          (LPVOID*)&original_rawget},
        {0x635140, (LPVOID)&lua51_remove,          (LPVOID*)&original_remove},
        {0x635BE0, (LPVOID)&lua51_rawset,          (LPVOID*)&original_rawset},
        {0x635340, (LPVOID)&lua51_isnumber,        (LPVOID*)&original_isnumber},
        {0x635470, (LPVOID)&lua51_tointeger,       (LPVOID*)&original_tointeger},
        {0x6350C0, (LPVOID)&lua51_atpanic,         (LPVOID*)&original_atpanic},
        {0x6352D0, (LPVOID)&lua51_type,            (LPVOID*)&original_type},
        {0x635DF0, (LPVOID)&lua51_call,            (LPVOID*)&original_call},
        {0x646920, (LPVOID)&lua51_open_base,       (LPVOID*)&original_open_base},
        {0x635070, (LPVOID)&lua51_xmove,           (LPVOID*)&original_xmove},
        {0x635A00, (LPVOID)&lua51_rawgeti,         (LPVOID*)&original_rawgeti},
        {0x635A40, (LPVOID)&lua51_createtable,     (LPVOID*)&original_createtable},
        {0x635710, (LPVOID)&lua51_pushlstring,     (LPVOID*)&original_pushlstring},
        {0x635C50, (LPVOID)&lua51_rawseti,         (LPVOID*)&original_rawseti},
        {0x635A80, (LPVOID)&lua51_getmetatable,    (LPVOID*)&original_getmetatable},
        {0x635190, (LPVOID)&lua51_insert,          (LPVOID*)&original_insert},
        {0x6351E0, (LPVOID)&lua51_replace,         (LPVOID*)&original_replace},
        {0x636950, (LPVOID)&lua51L_ref,            (LPVOID*)&originalL_ref},
        {0x636A00, (LPVOID)&lua51L_unref,          (LPVOID*)&originalL_unref},
        {0x6356D0, (LPVOID)&lua51_pushnumber,      (LPVOID*)&original_pushnumber},
        {0x635430, (LPVOID)&lua51_tonumber,        (LPVOID*)&original_tonumber},
        {0x635380, (LPVOID)&lua51_isstring,        (LPVOID*)&original_isstring},
        {0x6355F0, (LPVOID)&lua51_touserdata,      (LPVOID*)&original_touserdata},
        {0x6353F0, (LPVOID)&lua51_lessthan,        (LPVOID*)&original_lessthan},
        {0x636050, (LPVOID)&lua51_next,            (LPVOID*)&original_next},
        {0x636090, (LPVOID)&lua51_concat,          (LPVOID*)&original_concat},
        {0x635550, (LPVOID)&lua51_objlen,          (LPVOID*)&original_objlen},
        {0x635AE0, (LPVOID)&lua51_getfenv,         (LPVOID*)&original_getfenv},
        {0x635D70, (LPVOID)&lua51_setfenv,         (LPVOID*)&original_setfenv},
        {0x6365B0, (LPVOID)&lua51L_getmetafield,   (LPVOID*)&originalL_getmetafield},
        {0x636040, (LPVOID)&lua51_error,           (LPVOID*)&original_error},
        {0x63F890, (LPVOID)&lua51_yield,           (LPVOID*)&original_yield},
        {0x6457D0, (LPVOID)&lua51open_string,      (LPVOID*)&original_open_string},
        {0x643C50, (LPVOID)&lua51open_math,        (LPVOID*)&original_open_math},
        {0x6434E0, (LPVOID)&lua51open_table,       (LPVOID*)&original_open_table},
        {0x641320, (LPVOID)&lua51_getinfo,         (LPVOID*)&original_getinfo},
        {0x6406B0, (LPVOID)&lua51_getstack,        (LPVOID*)&original_getstack},
        {0x5C8950, (LPVOID)&reportError,           (LPVOID*)&original_scriptcontextreport},
        {0x641800, (LPVOID)&lua51_close,           (LPVOID*)&original_close},
        {0x6353B0, (LPVOID)&lua51_rawequal,        (LPVOID*)&original_rawequal},
        {0x6354B0, (LPVOID)&lua51_toboolean,       (LPVOID*)&original_toboolean},
        {0x6352F0, (LPVOID)&lua51_typename,        (LPVOID*)&original_typename},
        {0x6357F0, (LPVOID)&lua51_pushfstring,     (LPVOID*)&original_pushfstring},
        {0x635640, (LPVOID)&lua51_topointer,       (LPVOID*)&original_topointer},
        {0x636F20, (LPVOID)&lua51L_checkany,       (LPVOID*)&originalL_checkany},
        {0x636D60, (LPVOID)&lua51L_argerror,       (LPVOID*)&originalL_argerror},
        {0x6356B0, (LPVOID)&lua51_pushnil,         (LPVOID*)&original_pushnil},
        {0x636B00, (LPVOID)&lua51L_loadfile,       (LPVOID*)&originalL_loadfile}
    };
